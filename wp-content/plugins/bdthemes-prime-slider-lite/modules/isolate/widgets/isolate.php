...
class Isolate extends Widget_Base {
						...
						<div class="bdt-prime-slider-container">
							<div class="bdt-header-inner bdt-flex bdt-flex-middle" bdt-grid>
								...
								<div class="bdt-width-expand">
									<?php $menu_align = ( 'locate' == $skin_name or 'slice' == $skin_name ) ? 'bdt-navbar-center' : 'bdt-navbar-right' ?>
									<?php $this->render_menu( $menu_align ); ?>
								</div>
							</div>
						</div>
					</header>
	...
	public function render_scroll_button() {
		...
		?>
			<div <?php echo $this->get_render_attribute_string('bdt-scroll-wrapper'); ?>>
				<span <?php echo $this->get_render_attribute_string('bdt-scroll-down'); ?>>
	...
	protected function render_play_button($slide) {
		...
		$this->add_render_attribute( 'lightbox', 'class', 'bdt-slide-play-button bdt-position-center', true );
