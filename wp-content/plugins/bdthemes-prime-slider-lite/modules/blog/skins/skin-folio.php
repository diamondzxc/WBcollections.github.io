    ...
    public function render_footer() {
      ...
      <div class="bdt-ps-meta-content bdt-position-bottom bdt-flex bdt-flex-between bdt-flex-middle">
          <?php if ( 'yes' == $settings['show_admin_info'] ) : ?>
            <div class="bdt-prime-slider-meta bdt-flex bdt-flex-middile" bdt-slideshow-parallax="x: 250,-250">
              <div
                  class="bdt-post-slider-author bdt-margin-small-right bdt-border-circle bdt-overflow-hidden bdt-visible@s">
                  <?php echo get_avatar(get_the_author_meta('ID'), 48); ?>
              </div>
              <div class="bdt-meta-author">
                <span
                    class="bdt-author bdt-text-capitalize"><?php esc_html_e('Written by', 'bdthemes-prime-slider'); ?><?php echo esc_attr(get_the_author()); ?> </span><br>
                <span><?php esc_html_e('On', 'bdthemes-prime-slider'); ?><?php echo get_the_date(); ?></span>
              </div>
            </div>
          <?php endif; ?>
